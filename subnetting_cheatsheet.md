# Subnetting Cheat Sheet (CIDR → Subnet Mask → Wildcard)

| CIDR | Subnet Mask       | Wildcard Mask    | Hosts (usable) |
|------|-------------------|------------------|----------------|
...
| /31* | 255.255.255.254   | 0.0.0.1          | 0 (point-to-point) |
| /32  | 255.255.255.255   | 0.0.0.0          | 1 (host route) |

Notes:
- Wildcard = inverse of subnet mask (255.255.255.255 minus mask).
- Usable hosts exclude network/broadcast except /31 (RFC 3021 point-to-point) and /32 host routes.
